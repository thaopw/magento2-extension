...
class Tables
{
    ...
    public const TABLE_AMAZON_DICTIONARY_TEMPLATE_SHIPPING = self::PREFIX . 'amazon_dictionary_template_shipping';
    ...
    public const TABLE_AMAZON_TEMPLATE_SHIPPING = self::PREFIX . 'amazon_template_shipping';
